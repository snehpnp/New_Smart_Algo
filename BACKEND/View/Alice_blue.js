...
async function createTradeHistoryView() {
    try {
        await client.connect();
        ...
        const viewName = 'Trade_history';
        await db.createCollection(viewName, { viewOn: 'signals', pipeline });
...
// Call the function 
// createView();
module.exports = { createView, dropExistingView ,createTradeHistoryView}
