                ...
                <div className="row">
                    ...
                    <div className="col-12">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <div className="table-responsive">
                                    <table id="example3" className="display" style={{ minWidth: 845 }}>
                                        <thead>
                                            <tr>
                                                <th />
                                                <th>Name</th>
                    ...
                    <div className="col-12">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <div className="table-responsive">
                                    <table id="example4" className="display" style={{ minWidth: 845 }}>
                                        <thead>
                                            <tr>
                                                <th>Roll No</th>
                                                <th>Student Name</th>
                    ...
                    <div className="col-12">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <div className="table-responsive">
                                    <table id="example5" className="display" style={{ minWidth: 845 }}>
                                        <thead>
                                            <tr>
                                                <th>
