...
const Edit_panel = () => {
    ...
    // console.log("getGetAllBrokerName",getGetAllBrokerName);
    ...
    useEffect(() => {
        if (UserData.data.strategy) {
            ...
            ({
                id: broker.broker_id,
                name: broker.name,
                checked: UserData.data.data.broker_id.some((item) => item.broker_id === broker.id)
            }));
            console.log(initialSelectedBroker);

            setBrokerNames(initialSelectedBroker);
        }
    }, [UserData.data.broker_id, getGetAllBrokerName]);

    console.log("getBrokerNames", getBrokerNames);
    ...
    useEffect(() => {
        formik.setFieldValue('panel_name', UserData.data.data !== undefined && UserData.data.data[0].panel_name);
        formik.setFieldValue('domain', UserData.data.data !== undefined && UserData.data.data[0].domain);
        formik.setFieldValue('port', UserData.data.data !== undefined && UserData.data.data[0].port);
        formik.setFieldValue('key', UserData.data.data !== undefined && UserData.data.data[0].key);
        formik.setFieldValue('ip_address', UserData.data.data !== undefined && UserData.data.data[0].ip_address);
        formik.setFieldValue('theme_id', UserData.data.data !== undefined && UserData.data.data[0].theme_id);
        formik.setFieldValue('db_url', UserData.data.data !== undefined && UserData.data.data[0].db_url);
        formik.setFieldValue('db_name', UserData.data.data !== undefined && UserData.data.data[0].db_name);
        formik.setFieldValue('broker_id', UserData.data.data !== undefined && UserData.data.data[0].broker_id);
        formik.setFieldValue('Create_Strategy', UserData.data.data !== undefined && UserData.data.data[0].Create_Strategy);
        formik.setFieldValue('Option_chain', UserData.data.data !== undefined && UserData.data.data[0].Option_chain);
        formik.setFieldValue('Strategy_plan', UserData.data.data !== undefined && UserData.data.data[0].Strategy_plan);
