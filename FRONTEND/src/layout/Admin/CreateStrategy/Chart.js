...
const ChartComponent = ({ showModal, setshowModal, List, data1111 }) => {
    ...
    if(List.option_type != undefined){
     if(List.option_type.toUpperCase() =="PE"){
        option_type = "PUT"
     }
    }
    ...
    const symbol =  List.segment=="O"||List.segment=="MO"||List.segment=="CO"? List.symbol_name +' '+List.expiry+'  '+option_type+'  '+List.strike_price  : List.segment=="F"||List.segment=="MF"||List.segment=="CF" ? List.symbol_name +' '+List.expiry + ' FUTURE': List.symbol_name
