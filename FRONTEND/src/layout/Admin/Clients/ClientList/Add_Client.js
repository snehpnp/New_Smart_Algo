...
const AddClient = () => {
  ...
  useEffect(() => {
    ...
    formik.setFieldValue('fullName', location.state !== null && location.state.FullName || "");
    formik.setFieldValue('email', location.state !== null && location.state.Email || "");
    formik.setFieldValue('mobile', location.state !== null && location.state.PhoneNo || "");
  }, [location.state]);
  ...
  const handleStrategyChange = (event) => {
    ...
    const strategyName = event.target.name; // Assuming the label contains the strategy
  ...
  [
    ...
    },
    {
      ...
      showWhen: values =>
        //  values.broker === '2' ||
        values.broker === '1' || values.broker === '2' || values.broker === "3" || values.broker === '5' || values.broker === '9' || values.broker === '11' || values.broker === '13' || values.broker === '14' || values.broker == '21',
      label_size: 12, col_size: 6, disable: false
    },
    {
      name: 'app_key',
