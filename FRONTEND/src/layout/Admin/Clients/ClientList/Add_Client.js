  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      const req = {
        ...
        "parent_id": values.parent_id == null || values.parent_id === "" ? user_details.user_id : values.parent_id,
  ...
  let fields = [
    ...
    },
    {
      ...
      showWhen: values => values.broker === '1'
        ||
        values.broker === '3' || values.broker === '5' || values.broker === '6' || values.broker === '7' || values.broker === '8' || values.broker === '9' || values.broker === '10' || values.broker === '11' || values.broker === '13' || values.broker === '14' || values.broker === '15' || values.broker === '19' || values.broker === '26' || values.broker === '25',
      label_size: 12, col_size: 6, disable: false
    },
    {
      name: 'api_type',
