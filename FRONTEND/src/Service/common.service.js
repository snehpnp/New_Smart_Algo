...
export async function GET_ALL_SERVICE_FOR_CLIENTS(data, token) {
  try {
    const res = await axios.get(
      `${Config.base_url}getall/strategy_for_add_client`,
      data,
      {
...
export async function GET_OPTION_SYMBOLS_EXPIRY(data, token) {
  try {
    const res = await axios.post(
      `${Config.base_url}get/option_symbol_expiry`,
      data,
      {
        headers: header(token),
      }
...
export async function OPTION_SYMBOLS_UPDATE_STATUS(data, token) {
  try {
    const res = await axios.post(
      `${Config.base_url}update/option_symbols_status`,
      data,
      {
        headers: header(token),
      }
...
export async function GET_OPTION_ALL_ROUND_TOKEN(data, token) {
  try {
    const res = await axios.post(
      `${Config.base_url}get/all_round_token`,
      data,
      {
        headers: header(token),
      }
...
export async function UPDATE_SUBSCRIBE_TOKEN(data, token) {
  try {
    const res = await axios.post(
      `${Config.base_url}update/subscribe/token`,
      data,
      {
        headers: header(token),
      }
...
export async function GET_TIMEFRAME(data, token) {
  try {
    const res = await axios.post(
      `${Config.base_url}get/getAlltimeframe`,
      data,
      {
        headers: header(token),
      }
...
export async function DELETE_MAKE_STRATEGY_SELECTED(data, token) {
  try {
    const res = await axios.post(
      `${Config.base_url}DeleteMakeStartegySelected`,
      data,
      {
        headers: header(token),
      }
...
export async function STATUSCHANGE_MAKE_STRATEGY(data, token) {
  try {
    const res = await axios.post(
      `${Config.base_url}StatusChangeMakeStartegy`,
      data,
      {
        headers: header(token),
      }
