        ...
        <div className={`row d-flex justify-content-center `}>
              ...
              {field.type === "select" ? (
                ...
                <>
                  {field.options && field.options.length > 0 ? (
                                ...
                                <div className="col-lg-12 ">
                                  <div className="form-check custom-checkbox mb-3">
                                    <input
                                      ...
                                      id={option.label}
                                      {...formik.getFieldProps(option.label)}
                                    />
                                    <label
                    ...
                    <>
                      <div
                        className={`col-lg-${title === "addgroup" ? 2 : 3}`}
                        key={field.id}
                      >
                        <div className="row d-flex">
                          <div className="col-lg-12 ">
                      ...
                      <div className="col-lg-12 ">
                        <div className="form-check custom-checkbox mb-3">
                          ...
                          <input
                            ...
                            {...formik.getFieldProps(field.name)}
                            min={
                              field.name === "todate" ? fromDate : field.name
                            }
                          />
                        </div>
                        {formik.errors[field.name] && (
                ...
                <>
                  <div className="col-lg-12">
                    <div className="row d-flex">
                      <div className="col-lg-12 ">
                        <div className="mb-3">
                          <label className="col-lg-4 " htmlFor={field.name}>
                            {field.label}
                          </label>
                          <textarea
                            className="form-control"
                ...
                <div
                  className={`col-lg-${
                    title === "forlogin1" || title === "brokerkey"
                      ? 12
                      : title === "forResetPassword"
                      ? 12
                      : title === "forUpdatePassword"
                      ? 12
                      : 6
                  ...
                  <div className="mb-3 d-flex justify-content-center row">
                    ...
                    <div
                      className={`col-lg-${
                        title === "forlogin1"
                          ? 12
                          : title === "forResetPassword" || "forUpdatePassword"
                          ? 12
                          : 7
                      } `}
                    >
                ...
                <div
                  className={`col-lg-${
                    title === "forlogin" || title === "brokerkey"
                      ? 12
                      : title === "forResetPassword"
                      ? 12
                      : title === "forUpdatePassword"
                ...
                >
                  <div className="mb-3 row">
                    <label
                      className={`col-lg-${
                        title === "forlogin" ? 3 : title === "brokerkey" ? 6 : 4
                      } col-form-label `}
                      htmlFor={field.name}
                    >
                      {field.label}
                    ...
                    >
                      ...
                      <input
                        ...
                        readOnly={field.disable}
                        autoComplete="off"
                        onFocus={(e) => e.target.setAttribute('autocomplete', 'new-username')}
                      />
          ...
          <div className="form-group mb-0">
            {btn_name == "sneh" ? (
              ...
              <>
                <button
                  className={`btn btn-primary col-lg-12 btn-rounded ${
                    location.pathname === "resetpassword" ? "col-md-11" : ""
                  }`}
                  type="submit"
                  disabled={btnStatusloading}
                >
                  {btn_name}
                </button>
              </>
