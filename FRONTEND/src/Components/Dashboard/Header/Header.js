        ...
        <Modal.Body>
          ...
          >
            ...
            >
              ...
              >
                <li style={{ marginBottom: "10px" }}>Great product experience</li>
                <li style={{ marginBottom: "10px" }}>Amazing customer support</li>
            ...
            >
              {kotakStatus1 ? (
                // OTP Section
                <div >
                  <h2 style={{ marginBottom: "20px", color: "#333" }}>Enter OTP</h2>
        ...
        />
                  ...
                  <div style={{ display: "flex", flexDirection: "column", width: "100%" }}>
                    ...
                    <button
                      ...
                      onMouseOver={(e) => (e.currentTarget.style.backgroundColor = "#a8d6ff")}
                      onMouseOut={(e) => (e.currentTarget.style.backgroundColor = "#d8ecff")}
                    >
                      Back
                    </button>
                  </div>
                ...
                >
                  <div style={{ display: "flex", marginBottom: "10px" }}>
                    <button
                      style={{
                        backgroundColor: activeTab === "mobile" ? "#d8ecff" : "white",
                        border: "1px solid #ccc",
                        padding: "10px 20px",
                        borderRadius: "5px",
                        cursor: "pointer",
                    ...
                    <button
                      style={{
                        backgroundColor: activeTab === "pan" ? "#d8ecff" : "white",
                        border: "1px solid #ccc",
                        padding: "10px 20px",
                        borderRadius: "5px",
                        cursor: "pointer",
                    ...
                    <button
                      style={{
                        backgroundColor: activeTab === "qr" ? "#d8ecff" : "white",
                        border: "1px solid #ccc",
                        padding: "10px 20px",
                        borderRadius: "5px",
                        cursor: "pointer",
